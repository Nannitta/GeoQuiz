          ...
          { country && regionTranslate && capitalTranslate
            ? <div className='lp:flex lp:gap-20 lp:mb-8 ds:justify-center ds:items-center ds:h-3/5 ds:mt-6'>
              <article className='font-akshar pl-6 pr-6 tb:text-2xl ds:w-96'>
                <h1 className='font-lilita text-3xl tb:mt-8 tb:text-5xl lp:mt-4 ds:mt-8'>{country[0].translations.spa.common}</h1>
              ...
              <aside className='flex flex-col w-full justify-center items-center mt-6 pb-6 lp:pb-0 lp:mt-0 ds:mt-6'>
                ...
                <Link to={'/lista-paises'} className='flex w-full justify-center items-center font-akshar text-lg pt-4 hover:text-secondary-color lp:text-2xl'>〱 VOLVER</Link>
              </aside>
            </div>
            : <Skeleton/>
          }
