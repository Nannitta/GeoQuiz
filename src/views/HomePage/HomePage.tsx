...
const HomePage = () => {
  return (
    <main className='text-primary-dark-color h-full bg-background bg-repeat lp:grid lp:grid-cols-homepage lp:justify-items-center lp:items-center'>
      ...
      <section
        className='px-8 flex flex-col gap-2 mb:gap-4 tb:px-[7rem] tb:gap-8 lp:p-0 lp:gap-2 lp:justify-center border lp:shadow-container-sh rounded-[2.5rem] lp:w-4/5 lp:h-[95%] lp:border-none bg-primary-light-color ds:px-16 ds:gap-10'>
        <h1 
